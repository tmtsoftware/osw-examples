...
object Common {
  ...
  val CommandMap: Map[CommandName, Setup => String] = Map(
    ...
    TARG_GEN.COMMAND_NAME          -> TARG_GEN.toCommand,
    CONFIG_CUR_LOOP.COMMAND_NAME   -> CONFIG_CUR_LOOP.toCommand,
    CONFIG_ACT_VC.COMMAND_NAME     -> CONFIG_ACT_VC.toCommand,
    CONFIG_ACT_OFFLD.COMMAND_NAME  -> CONFIG_ACT_OFFLD.toCommand,
    CONFIG_ACT_SNUB.COMMAND_NAME   -> CONFIG_ACT_SNUB.toCommand,
